...
- **FRUZAQLA Claims Analytics Pipeline**  
  End-to-end **SQL pipeline** with KPI calculations, rolling trends (R3M/R6M), adherence, persistence, provider adoption, and **Power BI dashboards** for US oncology claims.  
...
- **Finance & Business Dashboards**  
  Interactive **Power BI dashboards** demonstrating insights in finance, automobiles, airlines, and other sectors.  
